...
class Detail extends Component {
  ...
  componentDidMount() {
    ...
    .then(contributors => {
      ...
      this.getBlockCategoryItems(['revista', 'libro']);
    })
    .catch(err => {
      // Error
    });
  ...
  getOrderedCategories(pagedata){
    //@TODO PUSH NEW ONES TO HARDCODED ARRAY!!!
    //@TIP HEY! CAN BE REPLACED FOR getUniqueCategories(pagedata)!!!!!!
    ...
    window.$uniqueCategories = uniqueCategories;
            ...
            <div id="Detail" className="pb-xl">
              ...
              <div className="container container">
                  <div className="items-wrapper">
                    ...
                    {this.state.isLoading ? <LoadingSpinner /> : this.getOrderedCategories(this.state.recommendations)?.map((catName, i) =>
